...
set_but.grid(column=4,row=1,padx=padx,pady=pady)
...
rad_lin.grid(column=3,row=1)
rad_plan.grid(column=2,row=1)

vel=tk.CTkEntry(set_panel,textvariable=velocity)
vel.grid(column=1,row=1)
...
lbl=tk.CTkLabel(opt_panel,text="2000-50000 Hz",state='disabled')
...
baf=tk.CTkCheckBox(vis_panel,text="Baffle ",font=font)
baf.grid(padx=padx,pady=pady)
...
fls_view = tk.CTkButton(vis_panel,text="Side Fluid View",command=view_3di)
fls_view.grid(padx=padx,pady=pady)
flt_view = tk.CTkButton(vis_panel,text="Top Fluid View",command=view_3di)
flt_view.grid(padx=padx,pady=pady)
cov_view = tk.CTkButton(vis_panel,text="Coverage",command=view_3di)
cov_view.grid(padx=padx,pady=pady)
